            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required value="{{old('button_name')}}" name="button_name"  placeholder="button_name">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" required value="{{old('button_link')}}" name="button_link"  placeholder="button_link">
